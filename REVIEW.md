...
<!-- Personal note: I'm using this fork primarily to study the review pipeline
     and experiment with ML training scripts. The rules above are upstream's;
     I haven't changed them. If I diverge from upstream review conventions in
     my own PRs, that's intentional for learning purposes. -->
